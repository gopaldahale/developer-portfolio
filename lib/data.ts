...
export const projects: Project[] = [

  {
    ...
    liveUrl: "#",
    githubUrl: "https://github.com/gopaldahale",
    category: "Client Site",
    featured: true,
    gradient: "from-cyan-600/20 to-blue-600/20", 
    icon: "/imgs/netarx-logo.svg",
    demoSlides: [
      { type: "image", src: "/imgs/netarx-site-d.png", alt: "Live preview" },
    ],
  },
  {
    slug: "mailpilot",
  ...
  },
  {
    ...
    liveUrl: "https://deviratna-medicare.vercel.app/register",
    githubUrl: "https://github.com/gopaldahale/frontend-medicare",
    category: "Full Stack",
    featured: true,
    gradient: "from-emerald-600/20 to-teal-600/20",
    icon: "🏥",
    demoSlides: [{
      type: 'iframe', src: 'https://deviratna-medicare.vercel.app', alt: 'Live Preview'
    }],
  },
  {
    slug: "vrc-dashboard",
